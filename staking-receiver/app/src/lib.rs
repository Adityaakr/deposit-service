...
#[derive(Default)]
pub struct DepositReceiverService;

#[service(events = Event)]
impl DepositReceiverService {
    pub fn new() -> Self {
        Self::default()
    }
...
#[derive(Default)]
pub struct DepositReceiverProgram;

#[sails_rs::program]
impl DepositReceiverProgram {
    pub fn new() -> Self {
        Self::default()
    }
    
    #[export(route = "deposit_receiver")]
    pub fn deposit_receiver(&self) -> DepositReceiverService {
        DepositReceiverService::new()
    }
}
